...
class TestChart:
    ...
    def test_ctor(self, Chart):
        from legacy_openpyxl.charts import Legend
...
def bar_chart(ten_row_sheet, BarChart, Series, Reference):
    from legacy_openpyxl.styles.colors import GREEN
    ws = ten_row_sheet
    chart = BarChart()
    chart.title = "TITLE"
...
from legacy_openpyxl.writer.charts import BarChartWriter, BaseChartWriter
...
from legacy_openpyxl.tests.schema import chart_schema
