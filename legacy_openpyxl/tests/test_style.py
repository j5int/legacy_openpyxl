...
# package imports
from legacy_openpyxl.tests.helper import DATADIR, assert_equals_file_content
...
from legacy_openpyxl.writer.styles import  create_style_table
from legacy_openpyxl.writer.styles import write_style_table
