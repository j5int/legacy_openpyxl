...
__maintainer_email__ = 'legacy_openpyxl-users@googlegroups.com'
__url__ = 'http://legacy_openpyxl.readthedocs.org'
__downloadUrl__ = "http://bitbucket.org/ericgazoni/legacy_openpyxl/downloads"


def get_version():
    f = open(os.path.join(here, 'legacy_openpyxl', '__init__.py'))
    version_file = f.read()
    f.close()
