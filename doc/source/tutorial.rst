...
using the :func:`legacy_openpyxl[.]workbook.Workbook.active` property ::
...
using the :func:`legacy_openpyxl[.]workbook.Workbook.get_sheet_by_name` method ::
...
There is also the :func:`legacy_openpyxl[.]worksheet.Worksheet.cell` method::
...
You can also use the :func:`legacy_openpyxl[.]worksheet.Worksheet.range` method::
